...
class Intervals
{
    ...
    /**
     * функция возвращает время до конца аудиосеанса
     * @param var string $interval 
     * @param var int $days
     * return @var DateInterval  
     */
    public static function getHourBeforeEnd($interval, $days){
        $now = new DateTime("now");
        $endDate=new DateTime($now->format('Y-m-d')." "."$interval:00:00");
        if($days!=0)
