...
(function ($) {
  ...
  $.cleditor = {
    ...
    buttons: {
      ...
      "center,По центру,justifycenter|" +
      "alignright,Выравнивание справа,justifyright|" +
      "justify,По ширине,justifyfull|" +
      "undo,Назад,|" +
      "redo,Вперед,|" +
      "rule,Вставить Горизонтальную Черту,inserthorizontalrule|" +
      "image,Вставить Изображение,insertimage,url|" +
      "link,Вставка Гиперссылки,createlink,url|" +
