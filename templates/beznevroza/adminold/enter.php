        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="modal_login_form" method="post" action="<?php echo getActionLink("authorization", "login") ?>">
                    ...
                    <div class="clearfix">
                        <a href="http://beznevrozanet.ru/<?php echo getActionLink("registration", "forget") ?>" class="forget-password">Забыли пароль?</a>
                        <a href="http://beznevrozanet.ru/<?php echo getActionLink("registration") ?>" class="registration-link">Регистрация</a>
                    </div>
                </form>
            </div>
        </div>
