<?php
?>
<div class="modal fade confirm-window-simple" id="delete-audiosession" role="dialog">
    ...
    <table class="admin-table as-admin-table">
        <tr>
            ...
            <?php foreach($data['audiosessions'] as $asess): ?>
                ...
                <td> <audio id="audio<?php echo $asess->id?>"  src="<?php echo getMedia("audiosessions/".str_replace(".mp3",".encrypted", $asess->uri))?>"></audio> <div id="<?php echo $asess->id ?>" onclick="togglleState()" class="admin-play-button"></div></td>
