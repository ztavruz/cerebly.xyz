...
<div class="admin-left-menu">
    <ul>
        ...
        <li><a href="<?php echo getActionLink("comments") ?>">Комментарии</a></li>
...
<div class="admin-content">
    ...
    <div class="admin-breadcrumbs">
        <a href="<?php echo getActionLink("users") ?>">Пользователи</a> / <a href="<?php echo getActionLink("users", "user", array("id" => $data['user']->id ) ) ?>">Пользователь</a> / <a class="active" href="">Комментарии</a>
    </div>
    <!--      breadcrumbs        /-->
